...
def load_data(messages_filepath, categories_filepath):
    ...
    """
    # load datasets
    msg = pd.read_csv("disaster managemnet/ETL_Disas/messages.csv")
    cat = pd.read_csv("disaster managemnet/ETL_Disas/categories.csv")
    # merge datasets on common id and assign to df
    df=pd.merge(msg,cat,on="id",how="outer")
    return df
...
def save_data(df, database_filepath):
    ...
    engine = create_engine(f'sqlite:///{disaster_managemnet/ETL_Disas/disasterMsg.db}')
